    ...
    def test_kvec_weight(self):
        np.testing.assert_array_almost_equal(
            [[0.000000,  0.000000, 0.000000, 1.000000],
             [0.058824,  0.000000, 0.000000, 6.000000],
             [0.117647,  0.000000, 0.000000, 6.000000],
             [0.176471, -0.000000, 0.000000, 6.000000],
             [0.235294,  0.000000, 0.000000, 6.000000],
             [0.294118,  0.000000, 0.000000, 6.000000],
             [0.352941, -0.000000, 0.000000, 6.000000]],
            self.outcar.kvec_weight[:7])
        eq_(33, len(self.outcar.kvec_weight))
